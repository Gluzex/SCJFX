...
public class SC_data_miner {
    ...
    public static String[] Security_role_name= new String[12];
    public static String[] Security_role_path= new String[12];
    public static String[] Search_path= new String[12];
    public static String[] Search_path_for_ehd_acs= new String[12];
